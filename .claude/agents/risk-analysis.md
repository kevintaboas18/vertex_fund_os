...
7. **`Perfil Inversionista/Kevin.md`** — eres el ÚNICO especialista que lee el perfil: evalúa tanto el riesgo de poseer esta empresa como el fit con el perfil del inversionista (capital ~$1,000, agresivo/especulativo, horizonte 1–3 años, solo EE.UU., sin forex ni cripto). Con capital pequeño y opciones, el riesgo de ruina por mal sizing pesa más que el riesgo de la empresa: dilo explícitamente. No transcribas cifras del perfil — `risk.py` las lee del archivo
