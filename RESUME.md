...
| Macroeconómico (derecha) | **Los ocho últimos datos de alto impacto que salieron**, con sus tres columnas —salió · esperado · anterior—, un botón «Explícame qué está pasando» que traduce la sorpresa a lo que significa para la economía, para la gente y para cada uno de los once sectores, y debajo **los próximos datos con su hora ET**. Una fila por indicador **y por corte**: el IPC mensual y el interanual son dos datos y salen los dos, con el que cita el mercado delante. Los rótulos que FMP repite para la misma serie —«Inflation Rate YoY» y «CPI YoY»— se colapsan a uno para no gastar dos de los ocho huecos en decir lo mismo. |
